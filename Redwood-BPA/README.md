...
* __Redwood_BPA_ConversionRules.json__ - The Redwood BPA Conversion Rules json file that holds the Self Converion rules code samples.
...
2. The __folder__ should contain:
   ...
   * __Redwood_BPA_ConversionRules.json__ - The tool Conversion Rules json file that contains the Self Converion rules code.
