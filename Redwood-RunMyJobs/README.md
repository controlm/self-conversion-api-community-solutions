...
* __HelixControlM_Result.json__ - The Helix Control-M data created by the Helix Control-M Self-Conversion when converting the Redwood RunMyJobs sample data using the Redwood RunMyJobs conversion rules sample. 
